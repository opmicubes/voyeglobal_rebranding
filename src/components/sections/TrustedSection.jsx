    ...
    <section className="bg-[var(--color-surface)] py-16 md:py-20 rounded-b-[30px] md:rounded-b-[80px]">
      <div className="max-w-[1408px] mx-auto px-4 md:px-8">
        ...
        <div className="md:hidden grid grid-cols-1 gap-6">
          ...
          {/* LEFT CARD — mobile */}
          <div className="relative rounded-[13.5px] overflow-hidden min-h-[240px]">
            <Image
              src="/home/about1.png"
              ...
              loading="lazy"
            />
            <div className="absolute inset-0 bg-gradient-to-b from-white/60 to-transparent" aria-hidden="true" />
        ...
        <div className="hidden md:grid grid-cols-2 gap-6">
          ...
          <div className="relative rounded-3xl overflow-hidden min-h-[620px]">
            ...
            <div className="absolute top-0 start-0 p-12 z-10">
              <p className="text-[40px] font-light text-[var(--color-text-dark)]">Trusted by</p>
              <p className="text-[40px] font-light text-[var(--color-text-dark)]">
                <span className="font-bold">200k+ Travelers</span> Worldwide
              </p>
              <div className="flex items-center gap-4 mt-5">
                <div className="flex items-center gap-2">
                  <SiAppstore className="w-10 h-10 p-2 bg-white rounded-sm text-[var(--color-text-dark)]" aria-hidden="true" />
                  <span className="font-bold text-[38px] text-[var(--color-text-dark)]">4.5</span>
                  <span className="text-[var(--color-text-secondary)] text-[27px]">/5</span>
                </div>
                <div className="w-px h-6 bg-[var(--color-border)]" />
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[38px] text-[var(--color-text-dark)]">4.6</span>
                  <span className="text-[var(--color-text-secondary)] text-[27px]">/5</span>
                </div>
              </div>
            </div>
          ...
          <div className="relative rounded-3xl overflow-hidden min-h-[820px]">
            ...
            />
            <div className="absolute top-0 start-0 p-12 z-10">
              <p className="text-white text-[40px] mb-1">Send $5 to a friend.</p>
              <p className="text-white text-[40px] font-bold mb-6">Get $5 for your next eSIM.</p>
              <button className="bg-white text-[var(--color-brand)] font-semibold text-[23px] px-7 py-3 rounded-md hover:bg-white/90 transition-colors">
                Refer and Earn
              </button>
            </div>
          </div>
