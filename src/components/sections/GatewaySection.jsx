...
export function GatewaySection() {
  return (
    <section className="relative z-0 w-full">
      ...
      <div className="relative z-10 w-full pt-23 pb-7 px-5 md:px-8 md:py-20 min-h-[820px] md:min-h-[580px] flex items-start md:items-center">
      {/* Inner centering — matches PlansSection inner div */}
      <div className="max-w-[1408px] mx-auto w-full">
      {/* White card */}
      <div className="w-full sm:w-[50%] lg:w-[650px] bg-white/50 backdrop-blur-[70px] border border-white/70 rounded-[20px] md:rounded-[20px] p-6 md:p-9 flex flex-col justify-center gap-5 md:gap-6">

        {/* Section 1 */}
        <div className="flex flex-col gap-2">
          <h2 className="text-[var(--color-text-dark)] font-medium md:font-semibold text-[16.6px] md:text-2xl leading-snug">
            Your Gateway to Seamless Global Connectivity
          </h2>
          <p className="text-[#2a2a2e] text-[12.5px] md:text-sm leading-relaxed">
        ...
        {/* Section 2 */}
        <div className="flex flex-col gap-2">
          <h3 className="text-[var(--color-text-dark)] font-medium md:font-semibold text-[16.6px] md:text-2xl leading-snug">
